...
class SemanticDocumentSplitter:
    ...
    def __init__(self, embeddings=None, breakpoint_type: str = "percentile", breakpoint_threshold: float = 95):
        """
        ...
        if not SEMANTIC_CHUNKER_AVAILABLE:
            raise ImportError("SemanticChunker not available. Install with: pip install langchain-experimental")
        ...
        self.splitter = SemanticChunker(
            embeddings=embeddings, breakpoint_threshold_type=breakpoint_type, breakpoint_threshold_amount=breakpoint_threshold
        )
